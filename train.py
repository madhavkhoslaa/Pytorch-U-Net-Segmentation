...
Images= ImageLoader(Images="/Path/to/images", Annotations="/Path/to/Annotations", train_percentage= params['train_percentage'])
...
Test_Loadrt= DataLoader(Test, batch_size=params['batch_size'], shuffle=True)
